...
// â”€â”€â”€ Article type for homepage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function HomePage() {
  ...
  // Fallback data matching real articles â€” ensures variants always render
  const FALLBACK_ARTICLES: HomeArticle[] = [
    { title: "8 FyrtÃ¥rn Anchors: Earth's Orbital Celebrations â€” Solstices, Equinoxes & Cross-Quarters", slug: "eight-fyrtarn-anchors", column: "Natural Time", columnColor: "#6BCB77", description: "Earth Moves identifies 8 astronomical anchors marking our orbital journey: Perihelion, Imbolc, Vernal Equinox, Beltane, Summer Solstice, Lammas, Autumnal Equinox, and Winter Solstice.", date: "2026-03-09", readingTime: 5 },
  ...
  return (
    <>
      ...
      <section className="philosophy" id="philosophy">
        ...
        <cite className="reveal reveal-delay-2">â€” The Earth Moves Philosophy</cite>
      </section>
      ...
      <section className="instruments" id="instruments">
        ...
        <div className="instruments-grid">
          <div className="instrument-card reveal">
            <Image className="instrument-img" src="/images/watch-instrument.png" alt="Earth Moves Watch â€” Live polar projection with real-time day/night cycle" width={600} height={600} />
            <div className="instrument-body">
              <h3>The Watch</h3>
              <p>A 24-hour timepiece following Earth&apos;s rotation. See your location on a live polar projection with real-time day and night, the Moon&apos;s position, cities illuminated, and the ISS orbiting overhead â€” all moving as Earth truly does.</p>
          ...
          <div className="instrument-card reveal reveal-delay-1">
            <Image className="instrument-img" src="/images/calendar-instrument.png" alt="Earth Moves Calendar â€” Orbital view with zodiac constellations" width={600} height={600} />
            <div className="instrument-body">
              <h3>The Calendar</h3>
              ...
              <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
                ...
                <div className="reveal" style={{ textAlign: "center", marginBottom: "clamp(2.5rem, 5vw, 4rem)" }}>
                  ...
                  <p style={{
                    ...
                    Earth&apos;s rotation â€” as they truly are. Norwegian designed.
                  </p>
                </div>
                  ...
                  <Link href="/watches" style={{
                    ...
                    <div style={{ padding: "clamp(1.25rem, 2vw, 2rem)" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        }}>$1,200 USD Â· 41mm Â· Automatic</span>
                        <span style={{
                    ...
                    <div style={{ padding: "clamp(1.25rem, 2vw, 2rem)" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <span style={{
                          fontFamily: "'DM Mono', monospace",
                          fontSize: ".65rem", color: "var(--text-dim)", letterSpacing: ".04em",
                        }}>$1,200 USD Â· 41mm Â· Moon &amp; Tide</span>
                        <span style={{
                          fontSize: ".72rem", color: "var(--gold)", letterSpacing: ".04em",
                        }}>View â†’</span>
                      </div>
                ...
                <div className="reveal" style={{ textAlign: "center", marginTop: "2.5rem" }}>
                  ...
                  <p style={{
                    ...
                    PRE-ORDER NOW Â· FREE WORLDWIDE SHIPPING
                  </p>
                </div>
              </div>
      ...
      <section className="tedtalk" id="talk">
        <a href="https://www.youtube.com/watch?v=5YKttXvoBZk" target="_blank" rel="noopener noreferrer" className="tedtalk-visual reveal">
          <Image src="/images/tedx-talk.webp" alt="Brage Johansen TEDx Talk â€” A Natural Concept of Time" width={800} height={450} style={{ width: "100%", height: "auto", display: "block" }} />
        ...
        <div className="tedtalk-text reveal reveal-delay-1">
          ...
          <p>In this TEDx talk, Brage W. Johansen presents his philosophy on how our perception of time has become disconnected from nature. He introduces Earth Moves as a bridge between human constructs and cosmic cycles â€” reconnecting us to time as it was meant to be experienced.</p>
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   THE EPHEMERIS â€” "The Bento" (dashboard grid, varied card sizes)
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
    ...
    <section id="ephemeris" style={{
      ...
      {arts.length >= 5 ? (
        <div className="reveal eph-g-grid" style={{
          ...
          {/* Featured â€” spans 7 cols, 2 rows */}
            ...
            <div style={{ position: "relative", zIndex: 1, padding: "2rem 2.25rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                <span style={{ fontFamily: "'DM Mono', monospace", fontSize: ".65rem", color: "var(--text-dim)" }}>
                  {fmtLong(arts[0].date)} Â· {arts[0].readingTime} min
                </span>
                <span style={{ fontSize: ".72rem", color: "var(--gold)", letterSpacing: ".04em" }}>Read â†’</span>
              </div>
            </div>
          </Link>
          ...
          {arts.slice(3, 5).map((a) => (
            <Link key={a.slug} href={`/ephemeris/${a.slug}`} className="eph-g-card eph-g-bottom" style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: ".75rem" }}>
                <span style={{ fontFamily: "'DM Mono', monospace", fontSize: ".6rem", color: "var(--text-dim)" }}>{fmtShort(a.date)} Â· {a.readingTime} min</span>
                <span style={{ fontSize: ".65rem", color: "var(--gold)", letterSpacing: ".04em" }}>Read â†’</span>
              </div>
            </Link>
          ))}
        </div>
