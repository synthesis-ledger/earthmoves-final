      ...
      <section className="instruments" id="instruments">
        ...
        <div className="instruments-grid">
          <div className="instrument-card reveal">
            <Image className="instrument-img" src="/images/watch-instrument.png" alt="Earth Moves Watch — Live polar projection with real-time day/night cycle" width={600} height={600} />
          ...
          <div className="instrument-card reveal reveal-delay-1">
            <Image className="instrument-img" src="/images/calendar-instrument.png" alt="Earth Moves Calendar — Orbital view with zodiac constellations" width={600} height={600} />
            <div className="instrument-body">
              <h3>The Calendar</h3>
...
/* ═══════════════════════════════════════════════════════════════════════
   THE EPHEMERIS — "The Bento" (dashboard grid, varied card sizes)
   ═══════════════════════════════════════════════════════════════════════ */
